...
from COTIFAC.models import Producto

class Command(BaseCommand):
    help = "Importa productos desde COTIFAC/productos.csv (con punto y coma) e ignora filas vacías."

    def handle(self, *args, **kwargs):
        file_path = "COTIFAC/productos.csv"
        total = 0
